...
#cgo LDFLAGS: -framework CoreFoundation -framework AudioToolbox -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework CoreServices -framework Security -liconv -lz -lbz2 -llzma
*/
import "C"
